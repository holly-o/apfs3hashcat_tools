...
ApfsVolume *ApfsContainer::GetVolume(unsigned int index, int &init_rc, const std::string &passphrase, bool prompt_for_password)
{
	...
	init_rc = vol->Init(omr.paddr, prompt_for_password);
