...
constexpr uint16_t DT_UNKNOWN_16 = 0;
constexpr uint16_t DT_FIFO_16 = 1;
constexpr uint16_t DT_CHR_16 = 2;
constexpr uint16_t DT_DIR_16 = 4;
constexpr uint16_t DT_BLK_16 = 6;
constexpr uint16_t DT_REG_16 = 8;
constexpr uint16_t DT_LNK_16 = 10;
constexpr uint16_t DT_SOCK_16 = 12;
constexpr uint16_t DT_WHT_16 = 14;
